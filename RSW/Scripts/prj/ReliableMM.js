$(document).ready(function () {
    ...
    function InsertTotalAfterSorted() {
        ...
        $.ajax({
            dataType: 'json',
            url: $.AppConfigOptions.baseurl + 'ReliableMonth/GDataMM',
            type: "post",
            ...
            success: function (data) {
                ...
                if (data[0] != '' && data[1] != '' && data[2] != '') {
                    ...
                    var content = '<tr data-index="9999"> \
                           <td class="dou-field-dev_id"></td> \
                           <td class="dou-field-stt_no"></td> \
                           <td class="dou-field-YYYYMM">總計：</td> \
                           <td class="dou-field-UpdateRate_MM" style="text-align: right; ">'+ data[0] + '</td> \
                           <td class="dou-field-RealTimeRate_MM" style="text-align: right; ">'+ data[1] + '</td> \
                           <td class="dou-field-ReliableRate_MM" style="text-align: right; ">'+ data[2] + '</td> \
                       </tr>';
