$(document).ready(function () {
    ...
    function InsertTotalAfterSorted() {
        ...
        $.ajax({
            dataType: 'json',
            url: $.AppConfigOptions.baseurl + 'ErrorMonthlyReport/GDataMM',
            type: "post",
            ...
            success: function (data) {
                ...
                if (data[0] != '' && data[1] != '' && data[2] != '') {
                    ...
                    var content = '<tr data-index="9999"> \
                           ...
                           <td class="dou-field-SumAlarm1" style="text-align: right; ">'+ data[0] + '</td> \
                           <td class="dou-field-SumAlarm2" style="text-align: right; ">'+ data[1] + '</td> \
                           <td class="dou-field-SumAlarm3" style="text-align: right; ">'+ data[2] + '</td> \
                       </tr>';
