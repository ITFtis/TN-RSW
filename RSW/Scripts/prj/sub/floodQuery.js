    ...
    pluginclass.prototype = {
        ...
        initUi: function () {
            ...
            if (this.settings.packagekmz) {
                ...
                $('<div class="col-md-4 col-4 package-kmz-container"> <img src="images/All_kmz.png" class="package-kmz" data-depth="0">全部 </div>').appendTo($_ctrl);
                $('<div class="col-md-4 col-4 package-kmz-container"> <img src="images/30_kmz.png" class="package-kmz"  data-depth="30">30cm↑</div>').appendTo($_ctrl);
                $('<div class="col-md-4 col-4 package-kmz-container"> <img src="images/50_kmz.png" class="package-kmz"  data-depth="50">50cm↑</div>').appendTo($_ctrl);
            }
            ...
            this.$confirm.on('click', function () {
                ...
                var et = current.$dtEnd.datetimepicker("date")._d.DateFormat(onlyD ? "yyyy/MM/dd 00:00:00" : "yyyy/MM/dd HH:mm:00");
...
var floodPinOptions = {
    //map: this.map,
    stTitle: function (d) { return d.NOTIFICATION_Data.Described ? d.NOTIFICATION_Data.Described : '-' },
    ...
    infoFields: [
        ...
        { field: 'Org_Name', title: '災點分區', showInInfo: false, showInList: false},
        { field: 'COUNTY_NAME', title: '縣市', showInInfo: false, showInList: false },
        { field: 'TOWN_NAME', title: '行政區', showInInfo: false, showInList: true},
        { field: 'GridId', title: '行政區', showInList: false, formatter: function (v, row) { return row.COUNTY_NAME + row.TOWN_NAME } },
        { field: 'DEPTH', title: '淹水(cm)', showInList: true, align:'right', unit: '公分', formatter: function (v, row) { return v==undefined || v<0?'---':v } },
        { field: 'DATE', title: '通報時間', formatter: function (v, row) { return JsonDateStr2Datetime(v).DateFormat('yyyy/MM/dd HH:mm:ss') } },
        { field: 'LOCATION_DESCRIPTION', title: '災害地點', showInList: true },
        { field: 'Described', title: '描述' },
        { field: 'X', title: 'X座標', showInInfo: false, showInList: false },
        { field: 'Y', title: 'Y座標', showInInfo: false, showInList: false},
        { field: 'IS_RECESSION', title: '狀況', showInList: false, formatter: function (v, row) { return  v?'已退水':'未退水' }},
        { field: 'AffectHouse', title: '影響戶數', showInInfo: false, showInList: false, formatter: function (v, row) { return helper.format.formatNumber(v, 0); } },
        { field: 'AffectArea', title: '影響面積(平方公尺)', showInInfo: false, showInList: false, formatter: function (v, row) { return helper.format.formatNumber(v, 0); } },
        { field: 'AffectHouse30cmUp', title: '影響戶數(30cm↑)', showInInfo: false, showInList: false, formatter: function (v, row) { return helper.format.formatNumber(v, 0); } },
        { field: 'AffectArea30cmUp', title: '影響面積(30cm↑)', showInInfo: false, showInList: false, formatter: function (v, row) { return helper.format.formatNumber(v, 0); } },
        { field: 'AffectHouse50cmUp', title: '影響戶數(50cm↑)', showInInfo: false, showInList: false, formatter: function (v, row) { return helper.format.formatNumber(v, 0); } },
        { field: 'AffectArea50cmUp', title: '影響面積(50cm↑)', showInInfo: false, showInList: false, formatter: function (v, row) { return helper.format.formatNumber(v, 0); } }
    ],
    ...
    pinInfoContent: function (data) {
        ...
        var $_ul = $('<ul class="nav nav-tabs" role="tablist">').appendTo($_root).hide(); ///////不提供
        ...
        if (data.Image_Data != null)
        {
            ...
            //$('<img src="'+app.siteRoot+'images/All_kmz.png" class="kmz-export glyphicon-export"" data-depth="0" title="kmz下載"></div>').appendTo($_href_flood_data);
            //$('<img src="' + app.siteRoot +'images/30_kmz.png" class="kmz-export glyphicon-export"" data-depth="30" title="kmz下載30cm以上"></div>').appendTo($_href_flood_data);
            //$('<img src="' + app.siteRoot +'images/50_kmz.png" class="kmz-export glyphicon-export"" data-depth="50" title="kmz下載50cm以上"></div>').appendTo($_href_flood_data);
    ...
    var _showDemToolTip = function ($_tooltip, _point, _msg, _isshow) {
        ...
        _showDemToolTiptimer = setTimeout(function () {
            if (_isshow) {
                ...
                }).attr('data-bs-original-title', _msg).tooltip('show');
            }
            else
